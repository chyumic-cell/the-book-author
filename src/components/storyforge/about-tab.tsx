...
const INTRO_SENTENCES = [
  `${APP_SENTENCE_NAME} is a professional long-form writing system built to help authors plan, draft, revise, and export books in one workspace.`,
  ...
  `${APP_SENTENCE_NAME} is intended to produce portable, publication-ready manuscripts and reader-facing exports while preserving editorial control, workflow clarity, and professional drafting discipline.`,
];
...
const ABOUT_POINTS = [
  ...
  `${APP_SENTENCE_NAME} is designed as a professional writing environment that keeps drafting, planning, continuity, and export tools in one place without forcing rigid workflow.`,
  ...
  `${APP_SENTENCE_NAME} is intended for desktop and mobile writing work, with desktop offering the deepest writing surface and mobile focusing on AI-led drafting plus human-led planning.`,
