...
const hostedOpenRouterModel = "mistralai/mistral-small-3.1-24b-instruct:free";
...
const defaultSecrets: ProviderSecrets = {
  ...
  openrouter: {
    ...
    model: (useHostedReadOnlyProviderConfig ? hostedOpenRouterModel : process.env.OPENROUTER_MODEL ?? "openrouter/free").trim(),
